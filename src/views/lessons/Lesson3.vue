      ...
      <div class="mt-4">
        ...
        <div class="grid md:grid-cols-2">
          <div class="flex bg-white">
            <img
              v-if="isVisible"
              src="@/assets/images/lesson_03.jpg"
